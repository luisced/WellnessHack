...
struct TimerCircleView: View {
    ...
    var body: some View {
        ZStack {
            // Background circle
            Circle()
                .stroke(Color.calendarMint.opacity(0.2), lineWidth: 8)
            ...
            Circle()
                ...
                .stroke(
                    LinearGradient(
                        colors: [Color.calendarMint, Color.calendarMint.opacity(0.7)],
            ...
            Circle()
                ...
                .shadow(color: Color.calendarMint.opacity(0.3), radius: 15, x: 0, y: 8)
